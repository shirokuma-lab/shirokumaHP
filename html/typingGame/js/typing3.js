'use strict';
    const textList = [
      'HyperTextMarkupLanguage','CascadingStyleSheets','JavaScript','software','hardware','StructuredQueryLanguage',
      'OpenSourceSoftware','GraphicalUserInterface','CharacterUserInterface','SoftwareArchitecture','DatabaseManagementSystem',
    ...
    document.getElementById('start').onclick = function(){
      ...
      setInterval(function(){
        ...
        if (sec == 0) {
          ...
          againGame.setAttribute("href", "muzui.html");
